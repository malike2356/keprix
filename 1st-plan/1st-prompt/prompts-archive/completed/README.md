...
Fable-class product power **292-297** is archived. Pending queue is clear for the next series. Reference outlines **138**, **144**, **149**, and **292** remain in `reference/`. Deferred polish items are documented in `PROMPT-IMPLEMENTATION-AUDIT.md`. Verification briefs for archived UI prompts: `../agent-briefs/`. Prompts 03-05 and 07 were superseded by the Hermes clone; see
