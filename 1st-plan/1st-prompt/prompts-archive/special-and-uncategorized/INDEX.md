...
| 372-375 | LLM threat-model hardening | Fail-closed prompt guard, tool ACL, RAG/Graphiti poison, Rule of Two + honest health; `ref-372-llm-threat-model-hardening-build-order.md` |
| 376-388 | viCal booking adoption | `src/keprix/vical/`, hub `/vical`, guest `/book/{slug}`; `376-388-*.md` |
| 389-402 | Capability mesh | Graph, DoD, Telegram pilot tools, IDs, discovery; `389-402-*.md` |
| 403-415 | Close Carina parity gaps | Tenancy + isolation, governance/DSAR, Scout, packs, product tools, RAG admin, self-knowledge, promo/BYOK, workflows, CI; gap doc status maps; `403-415-*.md`, `ref-403-keprix-carina-parity-build-order.md` |
| 416-428 | Public GTM + Hermes install parity | Curl installer, docs honesty, `keprixai.com`, ship gate, Contabo origin runbook; sign-off Verdict NOT READY; `416-428-*.md`, `ref-416-keprix-public-gtm-hermes-install-build-order.md` |
...
| Prompt | Title | Notes |
| --- | --- | --- |
| (none for 416-428) | - | Series archived 2026-08-07 |
| (standalone) | DATA ops surfaces upgrade | Archived 2026-08-07 as `data-ops-surfaces-upgrade.md`; Must P0-P4 shipped; P5/P6 deferred |

## Next active prompt after 00

No active pending prompts (queue empty aside from README). `data-ops-surfaces-upgrade.md` archived 2026-08-07 (Must P0-P4 + `/data` tabs; P5 Nice / P6 Ultimate deferred). Series **416-428** and **403-415** archived 2026-08-07. Reference outlines **138**, **144**, **149**, and **292** remain as `ref-*.md` in this folder. Deferred polish items are documented in `PROMPT-IMPLEMENTATION-AUDIT.md`. Verification records live beside archived prompts as `*-verification.md`. Prompts 03-05 and 07 were superseded by the Hermes clone; see
