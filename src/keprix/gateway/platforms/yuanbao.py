...
try:
    ...
    _KEPRIX_VERSION = "0.0.0"

_APP_VERSION = _KEPRIX_VERSION
_BOT_VERSION = _KEPRIX_VERSION
_YUANBAO_INSTANCE_ID = str(KEPRIX_INSTANCE_ID)  # single source: yuanbao_proto.KEPRIX_INSTANCE_ID
