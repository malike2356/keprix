...
Config: ~/.keprix/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.keprix/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_keprix_home()`` helper (KEPRIX_HOME-aware and
...
RULES_FILE = get_keprix_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_keprix_home() / "feishu_comment_pairing.json"
