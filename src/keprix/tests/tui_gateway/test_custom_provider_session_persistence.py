...
"No LLM provider configured. Run `keprix model`..." (resume failed) or
...
import keprix_cli.runtime_provider as rp
...
def _make_agent_with_override(override, monkeypatch, config):
    ...
    # Keep credential-pool resolution off the developer's real KEPRIX home.
