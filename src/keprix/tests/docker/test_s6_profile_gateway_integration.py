...
The unit tests in tests/keprix_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned keprix-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/keprix")
from keprix_cli.service_manager import S6ServiceManager
