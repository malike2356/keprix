...
to a generic "Your API key was rejected... run keprix setup" message, which is
...
def test_nous_401_guidance_strings_present():
    ...
    # Must give a concrete re-auth command, not a generic "keprix setup".
    assert "keprix portal" in source
