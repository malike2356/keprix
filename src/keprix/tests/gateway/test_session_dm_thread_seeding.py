...
def store(tmp_path, monkeypatch):
    ...
    ~/.keprix/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at keprix_state import time, before pytest's KEPRIX_HOME monkeypatch
    fires — the autouse fixture's KEPRIX_HOME override doesn't help here.)
    """
    import keprix_state
