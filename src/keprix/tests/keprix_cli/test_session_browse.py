"""Tests for the interactive session browser (`keprix sessions browse`).
...
from keprix_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """keprix sessions browse should be parseable."""
