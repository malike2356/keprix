...
The main() function in keprix_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `keprix -c model`
...
def _build_parser():
    """Build a minimal replica of the keprix top-level parser."""
