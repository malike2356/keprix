"""Tests for the specifier module + `keprix kanban specify` CLI surface.
...
from keprix_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `keprix kanban …` argparse surface directly."""
