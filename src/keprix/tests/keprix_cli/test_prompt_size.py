"""Tests for the ``keprix prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from keprix_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(keprix_home, memory_text="", user_text=""):
    mem_dir = keprix_home / "memories"
...
def _seed_skill(keprix_home, name, description):
    skill_dir = keprix_home / "skills" / "demo" / name
