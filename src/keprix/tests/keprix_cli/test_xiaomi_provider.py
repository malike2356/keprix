...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from keprix_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in KEPRIX_OVERLAYS
        overlay = KEPRIX_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify keprix doctor recognizes Xiaomi env vars."""
