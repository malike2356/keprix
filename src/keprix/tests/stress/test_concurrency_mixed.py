...
def worker_loop(worker_id: int, keprix_home: str, result_file: str) -> None:
...
def reclaimer_loop(keprix_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="keprix_mixed_stress_")
    print(f"KEPRIX_HOME = {home}")
