...
class TestErrorResponseShapes:
    ...
    def test_firecrawl_config_error_asks_for_api_key_or_self_host(self):
        ...
        assert "FIRECRAWL_API_URL" in message
        assert "Nous" not in message
        assert "Tool Gateway" not in message
