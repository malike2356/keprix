...
Run from the PR worktree:
    ...
    cd ~/.keprix/keprix/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.keprix/keprix``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.keprix/keprix
PR_DIR = REPO_ROOT  # the worktree we're in
assert (MAIN_DIR / "tools" / "browser_tool.py").exists(), (
    f"MAIN_DIR={MAIN_DIR} doesn't look like a keprix checkout"
)
...
# Isolated KEPRIX_HOME for the config write.
