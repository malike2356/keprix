...
Built for [Keprix](https://github.com/NousResearch/keprix). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/keprix/skills/creative/ascii-video`](https://github.com/NousResearch/keprix/tree/main/skills/creative/ascii-video) via PR.
