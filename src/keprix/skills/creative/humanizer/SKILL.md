...
version: 2.5.1
author: Siqi Chen (@blader, https://github.com/blader/humanizer), ported by Keprix
license: MIT
...
Also apply this skill to **your own** output when writing user-facing prose; release notes, PR descriptions, documentation, long-form explanations, summaries. Keprix's baseline voice already strips most of these, but a focused pass catches what slips through.

## How to use it in Keprix
...
> Done:  **Next Steps:** Schedule follow-up meeting
...
> - Done:  **Adoption:** Usage continues to grow, reflecting broader industry trends.
>
