...
```bash
python3 -m pyfiglet "KEPRIX" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=KEPRIX&font=Slant" | boxes -d stone
```
