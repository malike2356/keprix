...
metadata:
  keprix:
    ...
    related_skills: [claude-code, keprix]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Keprix terminal. Codex is OpenAI's autonomous coding agent CLI.
...
## Keprix Gateway Caveat

When invoking the Codex CLI from a Keprix gateway/service context (for example,
