#!/usr/bin/env python3
"""
SWE Runner with Keprix Trajectory Format

A runner that uses Keprix-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Keprix-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Keprix-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Keprix format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Keprix-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Keprix-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Keprix Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Keprix-Agent's built-in execution environments
    and outputs trajectories in Keprix-Agent format.
    """
    ...
    def _convert_to_keprix_format(
        ...
        """
        Convert internal message format to Keprix trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Keprix trajectory format
        trajectory = self._convert_to_keprix_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Keprix trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Keprix Trajectory Format")
    print("=" * 60)
