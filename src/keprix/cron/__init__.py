"""
Cron job scheduling system for Keprix.
...
Cron jobs are executed automatically by the gateway daemon:
    keprix gateway install    # Install as a user service
    sudo keprix gateway install --system  # Linux servers: boot-time system service
    keprix gateway            # Or run in foreground
