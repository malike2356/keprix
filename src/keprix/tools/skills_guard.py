...
Trust levels:
  - builtin:   Ships with Keprix. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.keprix/\.env|\~/\.keprix/\.env',
     "keprix_env_access", "critical", "exfiltration",
     "directly references Keprix secrets file"),
    ...
    (r'\.keprix/config\.yaml|\.keprix/SOUL\.md',
     "keprix_config_mod", "critical", "persistence",
     "references Keprix configuration files directly"),
...
# scan. `.skillignore` is the Keprix-native name; `.clawhubignore` is honored
