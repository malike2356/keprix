...
projection into Keprix' display, approval bridging, transcript projection into
...
"codex_app_server"`. Keprix' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("KEPRIX_KANBAN_TASK"):
            kanban_db = spawn_env.get("KEPRIX_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "KEPRIX_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("KEPRIX_HOME", os.path.expanduser("~/.keprix")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "keprix",
        client_title: str = "Keprix",
