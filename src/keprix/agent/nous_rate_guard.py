...
(3 SDK retries x 3 Keprix retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_keprix_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".keprix")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Keprix, ...) behind one endpoint.  A 429 can mean either:
