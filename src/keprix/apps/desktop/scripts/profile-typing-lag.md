...
cd apps/desktop
XCURSOR_SIZE=24 KEPRIX_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/keprix-typing
# → /tmp/keprix-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/keprix-typing.before.heapsnapshot
# → /tmp/keprix-typing.after.heapsnapshot
```
