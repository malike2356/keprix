 ...
 *
 * A public install can use the Keprix GitHub SSH remote.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/malike2356/keprix.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/malike2356/keprix'
