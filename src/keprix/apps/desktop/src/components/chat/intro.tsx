...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Keprix look at?',
    ...
    >
      <div className="w-full min-w-0">
        <BrandMark
          aria-hidden
          flush
          className="mx-auto mb-3 h-28 w-28 max-w-[min(12rem,55vw)] !size-auto sm:h-36 sm:w-36"
        />
        <p
          aria-label={WORDMARK}
          className="font-display fit-text mx-auto mb-1 w-[calc(100%-1rem)] bg-transparent font-bold uppercase leading-[0.9] tracking-[0.08em] text-midground dark:mix-blend-plus-lighter dark:text-foreground/90"
