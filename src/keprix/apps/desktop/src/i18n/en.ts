...
export const en: Translations = {
  ...
  boot: {
    ready: 'Keprix Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Keprix settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Keprix Desktop…'
    },
    errors: {
      backgroundExited: 'Keprix background process exited.',
      backgroundExitedDuringStartup: 'Keprix background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Keprix backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update Keprix',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Keprix Desktop.',
    ...
    native: {
      ...
      inputBody: 'Keprix is waiting for your response.',
      turnDoneTitle: 'Keprix finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Keprix defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Keprix is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Keprix asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Keprix was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Keprix follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Keprix checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Keprix configuration...',
    ...
    gateway: {
      ...
      intro:
        'Keprix Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Keprix backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Keprix backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Keprix backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Keprix Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Keprix ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription; no API key to copy. Keprix runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      connectAnother: 'Connect another provider',
      otherProviders: 'Other providers',
      removeConfirm: provider => `Remove ${provider}?`,
      removeExternal: (provider, command) => `${provider} is managed outside Keprix. Remove it with ${command}.`,
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Keprix desktop' },
    ...
    hermesActiveSessions: (version, count) => `Keprix ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Keprix environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Keprix will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Keprix...',
    placeholderReconnecting: 'Reconnecting to Keprix…',
    ...
    attachUrlDesc: 'Keprix will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Keprix can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Keprix is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Keprix backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Keprix from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Keprix will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Keprix updater will take over in its own window and reopen Keprix when it’s done.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Keprix reconnects automatically when it’s back.',
    applyingClose: 'Keprix will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Keprix needs a one-time install',
    ...
    settingUpTitle: 'Setting up Keprix',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Keprix CLI or desktop instance is running. Stop any running Keprix instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Keprix installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Keprix",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Keprix is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Keprix…',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Keprix at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser; Keprix connects automatically',
      loopback: 'Opens your browser to sign in; Keprix connects automatically',
    ...
    authorizeThere: 'Authorize Keprix there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Keprix there and you'll be connected automatically; nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Keprix inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Keprix will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Keprix is restarting...',
      askRestart: 'Ask Keprix to restart the server',
      lookingRestart: taskId => `Keprix is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Keprix is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Keprix finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Keprix could not restart the server.',
      stillWorking:
        'Keprix is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Keprix is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Keprix gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.keprix/config.yaml). Keprix won’t ask again for commands like this; in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Keprix needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Keprix needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Keprix Desktop to use Save Image.',
    restartToSaveImages: 'Restart Keprix Desktop to save images',
