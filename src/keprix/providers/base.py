...
def _profile_user_agent() -> str:
    """Return a ``keprix-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from keprix_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"keprix-cli/{_ver}"
    except Exception:
        return "keprix-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # keprix-cli UA so the catalog endpoint is reachable.
