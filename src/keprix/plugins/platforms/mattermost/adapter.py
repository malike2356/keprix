...
required — uses aiohttp which is already a Keprix dependency.
...
def interactive_setup() -> None:
    ...
    ``keprix_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Keprix delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # keprix_cli/setup.py::_setup_mattermost function.
