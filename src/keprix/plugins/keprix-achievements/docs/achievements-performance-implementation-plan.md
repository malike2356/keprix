# Keprix Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.keprix/plugins/keprix-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.keprix/plugins/keprix-achievements/scan_checkpoint.json`.
