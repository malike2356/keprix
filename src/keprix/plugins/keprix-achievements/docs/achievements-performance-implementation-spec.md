# Keprix Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.keprix/plugins/keprix-achievements/state.json` (existing unlock state)
  - `~/.keprix/plugins/keprix-achievements/scan_snapshot.json` (new)
  - `~/.keprix/plugins/keprix-achievements/scan_checkpoint.json` (new)
