...
DEFAULT_DATASETS = [
    ...
    "NousResearch/keprix-megascience-sft1",
    "NousResearch/Keprix-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Keprix-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-keprix"
]
