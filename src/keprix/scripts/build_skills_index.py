#!/usr/bin/env python3
"""Build the Keprix Skills Index — a centralized JSON catalog of all skills.
...
`keprix skills search/install` can use it without hitting the GitHub API.
...
# Ensure KEPRIX_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Keprix Skills Index...", flush=True)
