#!/usr/bin/env python3
"""Build the Keprix Model Catalog — a centralized JSON manifest of curated models.
...
Keprix CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Keprix release.
...
# Ensure KEPRIX_HOME is set for imports that touch it at module level.
os.environ.setdefault("KEPRIX_HOME", os.path.join(os.path.expanduser("~"), ".keprix"))

from keprix_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "keprix repo",
            "docs": "https://keprix.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
