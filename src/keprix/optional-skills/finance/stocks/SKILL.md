...
```
SCRIPT=~/.keprix/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.keprix/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
