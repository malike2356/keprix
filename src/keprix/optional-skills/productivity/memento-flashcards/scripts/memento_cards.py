...
Data file: $KEPRIX_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_KEPRIX_HOME = Path(os.environ.get("KEPRIX_HOME", Path.home() / ".keprix"))
DATA_DIR = _KEPRIX_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
