...
4. Name the token (e.g., "Keprix"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${KEPRIX_HOME:-~/.keprix}/.env`:
...
```bash
CANVAS="python $KEPRIX_HOME/skills/productivity/canvas/scripts/canvas_api.py"
