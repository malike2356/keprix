...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), Keprix
license: MIT
...
Helper script: `~/.keprix/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.keprix/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${KEPRIX_HOME:-~/.keprix}/.env`.
...
```bash
python3 ~/.keprix/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.keprix/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
