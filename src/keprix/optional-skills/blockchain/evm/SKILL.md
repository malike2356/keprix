...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Keprix
license: MIT
...
Helper script path: `~/.keprix/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.keprix/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.keprix/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.keprix/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
