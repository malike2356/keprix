...
def _has_keprix_browser() -> bool:
    ...
    # install.sh installs globally into $KEPRIX_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-KeprixHome", str(get_keprix_home()),
        ]
    else:
