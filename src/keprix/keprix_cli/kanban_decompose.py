...
Invoked by ``keprix kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Keprix board.
...
def _profile_author() -> str:
    """Mirror of ``keprix_cli.kanban._profile_author``."""
    return (
