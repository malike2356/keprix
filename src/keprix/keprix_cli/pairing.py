...
Usage:
    keprix pairing list              # Show all pending + approved users
    keprix pairing approve <platform> <code>  # Approve a pairing code
    keprix pairing revoke <platform> <user_id> # Revoke user access
    keprix pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle keprix pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: keprix pairing {list|approve|revoke|clear-pending}")
        print("Run 'keprix pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.keprix/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'keprix pairing list' to see pending codes.\n")
