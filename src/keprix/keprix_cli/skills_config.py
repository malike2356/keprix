"""
Skills configuration for Keprix.
`keprix skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.keprix/config.yaml under:
...
from keprix_cli.config import cfg_get, load_config, save_config
from keprix_cli.colors import Colors, color
from keprix_cli.platforms import PLATFORMS as _PLATFORMS
