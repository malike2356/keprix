"""``keprix tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'keprix tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # keprix tools list [--platform cli]
    ...
    # keprix tools disable <name...> [--platform cli]
    ...
    # keprix tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `keprix tools` runs after you pick a provider that\n"
