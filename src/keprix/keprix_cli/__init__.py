"""
Keprix CLI - Unified command-line interface for Keprix.

Provides subcommands for:
- keprix chat          - Interactive chat (same as ./keprix)
- keprix gateway       - Run gateway in foreground
- keprix gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `keprix setup` on a fresh Pi.
    ...
    keprix_cli/stdio.py::configure_windows_stdio() runs later from the entry
