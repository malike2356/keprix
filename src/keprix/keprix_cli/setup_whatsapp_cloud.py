...
Entry point: ``keprix whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``keprix_cli/main.py``).
...
Keprix gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("─" * 50)
    print()
    print("  Keprix needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Keprix gateway in another terminal:")
    print("         keprix gateway")
    print()
    ...
    print()
    print("  Docs: https://keprix.nousresearch.com/docs/user-guide/")
