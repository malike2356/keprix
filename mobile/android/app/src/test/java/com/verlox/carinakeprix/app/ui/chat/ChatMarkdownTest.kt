...
class ChatMarkdownTest {
  ...
  fun markdownLinksUseLabelTextAndDestinationUrl() {
    val annotated = buildChatInlineMarkdown("Open [docs](https://docs.keprix.local/help/testing) now")
    ...
    assertEquals("https://docs.keprix.local/help/testing", (links.single().item as LinkAnnotation.Url).url)
  }
