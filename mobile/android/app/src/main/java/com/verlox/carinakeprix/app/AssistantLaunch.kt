...
const val actionAskCarina = "com.verlox.carinakeprix.app.action.ASK_OPENCLAW"

/** Debug action that opens the Voice tab directly for Android E2E automation. */
const val actionOpenVoiceE2e = "com.verlox.carinakeprix.app.debug.OPEN_VOICE_E2E"
