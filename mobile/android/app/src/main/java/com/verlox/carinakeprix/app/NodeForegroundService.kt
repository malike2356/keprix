...
class NodeForegroundService : Service() {
  ...
  override fun onCreate() {
    super.onCreate()
    ensureChannel()
    val initial = buildNotification(title = "Carina Node", text = "Starting…")
    ...
    notificationJob =
      scope.launch {
        combine(
          ...
          val title =
            when {
              state.connected && state.mode == VoiceCaptureMode.TalkMode -> "Carina Node · Talk"
              state.connected -> "Carina Node · Connected"
              else -> "Carina Node"
            }
          val text =
  ...
  private fun ensureChannel() {
    ...
    val channel =
      NotificationChannel(
        ...
        description = "Carina node connection status"
        setShowBadge(false)
      }
  ...
  companion object {
    ...
    private const val ACTION_STOP = "com.verlox.carinakeprix.app.action.STOP"
    private const val ACTION_SET_VOICE_CAPTURE_MODE = "com.verlox.carinakeprix.app.action.SET_VOICE_CAPTURE_MODE"
    private const val EXTRA_VOICE_CAPTURE_MODE = "com.verlox.carinakeprix.app.extra.VOICE_CAPTURE_MODE"
