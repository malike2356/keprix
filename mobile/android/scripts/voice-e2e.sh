...
PACKAGE_NAME="com.verlox.carinakeprix.app"
RECEIVER="$PACKAGE_NAME/.VoiceE2eReceiver"
RUN_ACTION="com.verlox.carinakeprix.app.debug.RUN_VOICE_E2E"
OPEN_ACTION="com.verlox.carinakeprix.app.debug.OPEN_VOICE_E2E"
PORT=18789
HOST="127.0.0.1"
MODE="both"
...
adb logcat -d -v time |
  rg -i 'Carina|TalkMode|MicCapture|AudioRecord|SpeechRecognizer|realtime|talk.session|appendAudio|transcript|Talk failed|Transcription failed|Speech network|VoiceE2E' |
