...
private let appDefaultsSuites = ["com.verlox.carinakeprix.mac", "com.verlox.carinakeprix.mac.debug"]
    ...
    do {
        ...
        if opts.help {
            ...
            Options:
              ...
              --project-root <p>  Remote Carina checkout for CLI commands.
...
private func printConfigureRemoteOutput(_ output: ConfigureRemoteOutput, json: Bool) {
    ...
    print("Carina macOS Remote Config")
