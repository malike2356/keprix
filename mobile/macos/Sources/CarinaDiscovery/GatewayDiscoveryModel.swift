...
public final class GatewayDiscoveryModel {
    ...
    private let logger = Logger(subsystem: "com.verlox.carinakeprix", category: "gateway-discovery")
    ...
    public func start() {
        ...
        for domain in CarinaBonjour.gatewayServiceDomains {
            let browser = GatewayDiscoveryBrowserSupport.makeBrowser(
                serviceType: CarinaBonjour.gatewayServiceType,
                domain: domain,
                queueLabelPrefix: "com.verlox.carinakeprix.macos.gateway-discovery",
    ...
    public func refreshWideAreaFallbackNow(timeoutSeconds: TimeInterval = 5.0) {
        guard let domain = CarinaBonjour.wideAreaGatewayServiceDomain else { return }
    ...
    private func updateGateways(for domain: String) {
        ...
        if let wideAreaDomain = CarinaBonjour.wideAreaGatewayServiceDomain,
    ...
    private var hasUsableWideAreaResults: Bool {
        guard let domain = CarinaBonjour.wideAreaGatewayServiceDomain else { return false }
    ...
    private nonisolated static func prettifyInstanceName(_ decodedName: String) -> String {
        ...
        let stripped = normalized.replacingOccurrences(of: " (Carina)", with: "")
