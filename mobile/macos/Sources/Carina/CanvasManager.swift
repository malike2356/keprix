...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "com.verlox.carinakeprix", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Carina/canvas", isDirectory: true)
    }()
