...
private let onboardingWizardLogger = Logger(subsystem: "com.verlox.carinakeprix", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between CarinaProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = CarinaProtocol.AnyCodable
