...
struct SettingsRootView: View {
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? CarinaPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? CarinaPaths.stateDirURL.path
...
private struct SettingsTabGroup: Identifiable {
    ...
    static func defaultGroups(showDebug: Bool) -> [SettingsTabGroup] {
        var groups = [
            ...
            SettingsTabGroup(title: "Carina", tabs: [.about]),
        ]
