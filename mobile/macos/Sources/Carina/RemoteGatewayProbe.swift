...
enum RemoteGatewayAuthIssue: Equatable {
    ...
    var body: String {
        ...
        case .setupCodeExpired:
            "Scan or paste a fresh setup code from an already-paired Carina client, then try again."
        case .passwordRequired:
            "This onboarding flow does not support password auth yet. "
                + "Reconfigure the gateway to use token auth, then retry."
        case .pairingRequired:
            "Approve this device from an already-paired Carina client. "
                + "In your Carina chat, run `/pair approve`, then click **Check connection** again."
        }
    }
    ...
    var footnote: String? {
        ...
        case .setupCodeExpired:
            nil
        case .pairingRequired:
            "If you do not have another paired Carina client yet, "
    ...
    var statusMessage: String {
        ...
        case .pairingRequired:
            "Pairing required. In an already-paired Carina client, "
