...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "com.verlox.carinakeprix", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return CarinaConfigFile.defaultWorkspaceURL() }
