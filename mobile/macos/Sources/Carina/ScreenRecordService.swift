...
final class ScreenRecordService {
    ...
    private let logger = Logger(subsystem: "com.verlox.carinakeprix", category: "screenRecord")
...
private final class StreamRecorder: NSObject, SCStreamOutput, SCStreamDelegate, @unchecked Sendable {
    let queue = DispatchQueue(label: "com.verlox.carinakeprix.screenRecord.writer")
