...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            VStack(alignment: .center, spacing: 6) {
                ...
                AboutLinkRow(icon: "globe", title: "Website", url: "https://keprix.local")
            ...
            Text("© 2026 Carina Foundation — MIT License.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "CarinaBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "CarinaBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "CarinaGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "CarinaGitCommit") as? String) ??
            "unknown"
    }
