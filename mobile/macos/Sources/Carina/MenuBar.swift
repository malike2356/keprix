...
struct CarinaApp: App {
    ...
    private static let logger = Logger(subsystem: "com.verlox.carinakeprix", category: "app")
    ...
    var body: some Scene {
        ...
        Window("Carina Settings", id: SettingsWindowOpener.windowID) {
    ...
    private func applyStatusItemAppearance(paused _: Bool, sleeping _: Bool) {
        ...
        self.statusItem?.button?.toolTip = self.state.voiceWakeMeterActive
            ? "Carina - Voice Wake live meter active"
            : "Carina"
    }
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let webChatAutoLogger = Logger(subsystem: "com.verlox.carinakeprix", category: "Chat")
