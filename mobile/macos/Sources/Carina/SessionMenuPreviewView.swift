...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "com.verlox.carinakeprix", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> CarinaSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: CarinaSessionPreviewEntry,
    ...
    private static func cache(payload: CarinaSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: CarinaChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [CarinaKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [CarinaKit.AnyCodable]) -> [CarinaChatMessage] {
    ...
    private static func previewText(for message: CarinaChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: CarinaChatMessage) -> Bool {
    ...
    private static func toolNames(for message: CarinaChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: CarinaChatMessage) -> String? {
