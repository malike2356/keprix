...
final class PeekabooBridgeHostCoordinator {
    ...
    private let logger = Logger(subsystem: "com.verlox.carinakeprix", category: "PeekabooBridge")

    private var host: PeekabooBridgeHost?
    private var services: CarinaPeekabooBridgeServices?
    ...
    private static var openclawSocketPath: String {
        ...
        return Self.makeSocketPath(for: "Carina", in: base)
    }
    ...
    private func startIfNeeded() async {
        ...
        let services = CarinaPeekabooBridgeServices()
...
@MainActor
private final class CarinaPeekabooBridgeServices: PeekabooBridgeServiceProviding {
    ...
    init() {
        let logging = LoggingService(subsystem: "com.verlox.carinakeprix.peekaboo")
