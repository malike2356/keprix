...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "com.verlox.carinakeprix", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Carina windows, but below the system’s pop-up menus.
