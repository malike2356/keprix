...
final class HealthStore {
    ...
    private static let logger = Logger(subsystem: "com.verlox.carinakeprix", category: "health")
    ...
    var detailLine: String? {
        if let error = self.lastError, !error.isEmpty {
            ...
            if lower.contains("connection refused") {
                ...
                return "The gateway control port (\(host)) isn’t listening — restart Carina to bring it back."
            }
