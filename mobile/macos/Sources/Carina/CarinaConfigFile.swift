...
enum CarinaConfigFile {
    private static let logger = Logger(subsystem: "com.verlox.carinakeprix", category: "config")
    ...
    static func url() -> URL {
        CarinaPaths.configURL
    }

    static func stateDirURL() -> URL {
        CarinaPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        CarinaPaths.workspaceURL
    }
