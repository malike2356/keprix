...
public typealias CarinaPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias CarinaPlatformImage = UIImage
#endif

public struct CarinaChatUsageCost: Codable, Hashable, Sendable {
...
public struct CarinaChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: CarinaChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(CarinaChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct CarinaChatMessageContent: Codable, Hashable, Sendable {
...
public struct CarinaChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [CarinaChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: CarinaChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [CarinaChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: CarinaChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        let decodedUsage = try container.decodeIfPresent(CarinaChatUsage.self, forKey: .usage)
        ...
        if let decoded = try? container.decode([CarinaChatMessageContent].self, forKey: .content) {
...
public struct CarinaChatHistoryPayload: Codable, Sendable {
...
public struct CarinaSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct CarinaSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [CarinaSessionPreviewItem]
}

public struct CarinaSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [CarinaSessionPreviewEntry]

    public init(ts: Int, previews: [CarinaSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct CarinaChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct CarinaChatCreateSessionResponse: Codable, Sendable {
    public let ok: Bool?
    public let key: String
    public let sessionId: String?
}

public struct CarinaChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct CarinaSessionMessageEventPayload: Codable, Sendable {
    public let sessionKey: String?
    public let agentId: String?
    public let message: CarinaChatMessage?
...
public struct CarinaAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct CarinaChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct CarinaGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct CarinaPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: CarinaPlatformImage?
...
public struct CarinaChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
