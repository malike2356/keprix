...
public struct CarinaChatThinkingLevelOption: Codable, Identifiable, Sendable, Hashable {
...
public struct CarinaChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct CarinaChatSessionsDefaults: Codable, Sendable {
    public let modelProvider: String?
    public let model: String?
    public let contextTokens: Int?
    public let thinkingLevels: [CarinaChatThinkingLevelOption]?
    ...
    public init(
        ...
        model: String?,
        contextTokens: Int?,
        thinkingLevels: [CarinaChatThinkingLevelOption]? = nil,
...
public struct CarinaChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.key
    }
...
public struct CarinaChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: CarinaChatSessionsDefaults?
    public let sessions: [CarinaChatSessionEntry]
    ...
    public init(
        ...
        sessions: [CarinaChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
