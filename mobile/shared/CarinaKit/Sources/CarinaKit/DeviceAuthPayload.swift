...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: CarinaProtocol.AnyCodable]?
    {
        ...
        return [
            "id": CarinaProtocol.AnyCodable(identity.deviceId),
            "publicKey": CarinaProtocol.AnyCodable(publicKey),
            "signature": CarinaProtocol.AnyCodable(signature),
            "signedAt": CarinaProtocol.AnyCodable(signedAtMs),
            "nonce": CarinaProtocol.AnyCodable(nonce),
        ]
    }
}
