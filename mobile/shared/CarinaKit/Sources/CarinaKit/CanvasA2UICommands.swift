...
public enum CarinaCanvasA2UICommand: String, Codable, Sendable {
...
public struct CarinaCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct CarinaCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
