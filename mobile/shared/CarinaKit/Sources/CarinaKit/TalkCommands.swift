...
public enum CarinaTalkCommand: String, Codable, Sendable {
...
public struct CarinaTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct CarinaTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
