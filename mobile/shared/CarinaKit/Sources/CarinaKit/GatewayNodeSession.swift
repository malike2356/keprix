...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "com.verlox.carinakeprix", category: "node.gateway")
    ...
    {
        let timeoutLogger = Logger(subsystem: "com.verlox.carinakeprix", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: CarinaProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
