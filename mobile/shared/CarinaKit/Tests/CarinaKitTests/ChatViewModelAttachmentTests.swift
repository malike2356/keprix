...
private struct AttachmentProcessingTransport: CarinaChatTransport {
    func requestHistory(sessionKey _: String) async throws -> CarinaChatHistoryPayload {
...
final class ChatViewModelAttachmentTests: XCTestCase {
    func testImageAttachmentsAreProcessedBeforeStaging() async throws {
        ...
        let viewModel = await MainActor.run {
            CarinaChatViewModel(sessionKey: "main", transport: AttachmentProcessingTransport())
        }
