...
@Suite struct RootTabsPresentationTests {
    ...
    @Test func chatSidebarDestinationCanUseRouteHeaderInsteadOfAgentBranding() {
        ...
        #expect(ChatProTab.defaultHeaderTitle(showsAgentBadge: true, agentDisplayName: "Carina") == "Carina")
        #expect(ChatProTab.defaultHeaderTitle(showsAgentBadge: false, agentDisplayName: "Carina") == "Chat")
    }
