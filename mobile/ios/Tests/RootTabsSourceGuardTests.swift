...
@Suite struct RootTabsSourceGuardTests {
    @Test func hiddenSidebarRevealUsesDestinationHeaderWithoutReservedRail() throws {
        ...
        #expect(componentSource.contains("CarinaSidebarHeaderLeadingSlot"))
    ...
    @Test func sidebarKeepsNavigationModelDestinationOnly() throws {
        ...
        #expect(source.contains("CarinaProMark(size: 30"))
        #expect(source.contains("Text(\"Carina\")"))
    ...
    @Test func sidebarRoutesUseDestinationHeadersInsteadOfRepeatedProductBranding() throws {
        ...
        #expect(!sidebarDetail.contains("headerTitle: \"Carina\""))
        #expect(agentOverviewSource.contains("CarinaAdaptiveHeaderRow("))
        #expect(agentOverviewSource.contains("title: self.headerTitle"))
        #expect(!agentOverviewSource.contains("Text(\"Carina\")"))
        #expect(docsSource.contains("CarinaAdaptiveHeaderRow("))
        #expect(docsSource.contains("title: \"Docs\""))
        #expect(!docsSource.contains("Text(\"Carina Docs\")"))
    }
    ...
    @Test func agentsDirectRouteKeepsSingleSidebarControl() throws {
        ...
        #expect(nodesSource.contains("CarinaSidebarHeaderLeadingSlot(action: headerLeadingAction)"))
        #expect(dreamingSource.contains("CarinaSidebarHeaderLeadingSlot(action: headerLeadingAction)"))
    }
    ...
    @Test func routedHeadersUseSharedAdaptiveLayout() throws {
        ...
        #expect(componentsSource.contains("struct CarinaAdaptiveHeaderRow<Leading: View, Accessory: View>: View"))
        ...
        #expect(featureChromeSource.contains("CarinaAdaptiveHeaderRow("))
        #expect(docsSource.contains("CarinaAdaptiveHeaderRow("))
        #expect(overviewSource.contains("CarinaAdaptiveHeaderRow("))
        #expect(chatSource.contains("CarinaAdaptiveHeaderRow("))
        #expect(agentOverviewSource.contains("CarinaAdaptiveHeaderRow("))
        #expect(settingsSource.contains("CarinaAdaptiveHeaderRow("))
    }
    ...
    @Test func phoneHubKeepsDocsAsDestinationOnly() throws {
        ...
        #expect(source.contains("CarinaDocsScreen("))
        ...
        #expect(!source.contains("https://docs.keprix.local"))
    }
    ...
    @Test func phoneHubHeaderStaysTaskFirst() throws {
        ...
        #expect(source.contains("private var phoneDetailBackAction: CarinaSidebarHeaderAction"))
        #expect(source.contains("accessibilityLabel: \"Back to Control\""))
        #expect(source.contains("accessibilityIdentifier: \"CarinaPhoneDetailBackButton\""))
    ...
    @Test func activityScreenStaysSplitFromTaskFeatureScreens() throws {
        ...
        #expect(!taskSource.contains("import CarinaChatUI"))
    ...
    @Test func routedFeatureChromeStaysSplitFromTaskFeatureScreens() throws {
        ...
        #expect(chromeSource.contains("CarinaSidebarHeaderLeadingSlot(action: headerLeadingAction)"))
        #expect(chromeSource.contains("CarinaGatewayCompactPill()"))
    ...
    @Test func routedGatewayPillsOpenGatewaySettings() throws {
        ...
        #expect(agentOverviewSource.contains("CarinaGatewayCompactPill()"))
    ...
    @Test func gatewaySettingsKeepsPairingTrustDiagnosticsAndTailscaleActions() throws {
        ...
        #expect(actionsSource.contains("Run /pair approve in your Carina chat"))
    ...
    @Test func gatewaySettingsPreviewMatrixCoversPrimaryStates() throws {
        ...
        #expect(supportSource.contains("Run /pair approve in your Carina chat"))
    ...
    private static func proComponentsSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/Design/CarinaProComponents.swift")
    }
    ...
    private static func docsSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/Design/CarinaDocsScreen.swift")
    }
    ...
    private static func sharedChatPreviewSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("shared/CarinaKit/Sources/CarinaChatUI/ChatView+Previews.swift")
    }
    ...
    private static func xcodeProjectSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Carina.xcodeproj/project.pbxproj")
    }
