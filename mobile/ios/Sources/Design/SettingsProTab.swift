...
struct SettingsProTab: View {
    ...
    @AppStorage("location.enabledMode") var locationModeRaw: String = CarinaLocationMode.off.rawValue
    ...
    @State var previousLocationModeRaw: String = CarinaLocationMode.off.rawValue
