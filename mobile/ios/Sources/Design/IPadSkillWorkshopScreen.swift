...
struct IPadSkillWorkshopScreen: View {
    ...
    init(headerLeadingAction: CarinaSidebarHeaderAction? = nil, openSettings: @escaping () -> Void = {}) {
...
private struct IPadSkillProposalKanbanCard: View {
    ...
    var body: some View {
                    ...
                    HStack(alignment: .top, spacing: 10) {
                        ...
                        VStack(alignment: .leading, spacing: 4) {
                            Text(self.proposal.title)
                                .font(.subheadline.weight(.semibold))
                                .foregroundStyle(self.isSelected ? CarinaBrand.accent : .primary)
                                .lineLimit(2)
        ...
        .padding(12)
        .background(
            self.isSelected ? CarinaBrand.accent.opacity(0.08) : Color.clear,
...
struct IPadSkillProposal: Identifiable {
    ...
    var statusColor: Color {
        switch self.status {
        case "pending": CarinaBrand.warn
        case "applied": CarinaBrand.ok
        case "rejected": .secondary
        case "quarantined", "stale": CarinaBrand.warn
        default: CarinaBrand.accent
        }
    }
