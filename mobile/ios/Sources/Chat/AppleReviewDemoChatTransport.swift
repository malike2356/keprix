...
enum ScreenshotFixtureMode {
    static let gatewayName = "Carina Gateway"
...
struct LocalChatFixture {
    ...
    static let appScreenshots = LocalChatFixture(
        ...
        modelID: "gpt-5.5",
        modelName: "GPT-5.5",
        responsePrefix: "Carina is connected to your gateway.",
        seedMessages: [
            """
            Carina is connected to your gateway. I can coordinate agents, inspect project context, and prepare \
...
struct LocalFixtureChatTransport: CarinaChatTransport {
...
struct AppleReviewDemoChatTransport: CarinaChatTransport {
...
private actor LocalFixtureChatStore {
    private let fixture: LocalChatFixture
    private var messages: [CarinaChatMessage]
    ...
    func createSession(key: String) throws -> CarinaChatCreateSessionResponse {
        try Self.decode(
            CreateSessionPayload(ok: true, key: key, sessionId: "\(self.fixture.sessionIDPrefix)-\(key)"),
            as: CarinaChatCreateSessionResponse.self)
    }

    func history(sessionKey: String) throws -> CarinaChatHistoryPayload {
        ...
        return try Self.decode(
            HistoryPayload(
                ...
                thinkingLevel: "auto"),
            as: CarinaChatHistoryPayload.self)
    }

    func sendMessage(sessionKey _: String, message: String, runId: String) throws -> CarinaChatSendResponse {
        ...
        return try Self.decode(
            ...
            as: CarinaChatSendResponse.self)
    }

    func sessions() throws -> CarinaChatSessionsListResponse {
        let entry = CarinaChatSessionEntry(
            ...
            thinkingDefault: "auto")
        return CarinaChatSessionsListResponse(
    ...
    private static var thinkingLevels: [CarinaChatThinkingLevelOption] {
        [
            CarinaChatThinkingLevelOption(id: "auto", label: "Auto"),
    ...
    private static func seedMessages(fixture: LocalChatFixture) -> [CarinaChatMessage] {
        let now = Date().timeIntervalSince1970 * 1000
    ...
    private static func message(role: String, text: String, timestamp: Double) -> CarinaChatMessage {
        CarinaChatMessage(
            role: role,
            content: [
    ...
    private struct HistoryPayload: Encodable {
        ...
        var messages: [CarinaChatMessage]?
