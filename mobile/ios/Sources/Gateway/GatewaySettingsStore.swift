...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.verlox.carinakeprix.app.gateway"
    private static let nodeService = "ai.verlox.carinakeprix.app.node"
    private static let talkService = "ai.verlox.carinakeprix.app.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.verlox.carinakeprix.app", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.verlox.carinakeprix.app.gateway.diagnostics")
