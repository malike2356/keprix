...
struct OnboardingWizardView: View {
    ...
    @State private var statusLine: String = "In your Carina chat, run /pair qr, then scan the code here."
                ...
                Section {
                    ...
                    Text(
                        "Approve this device on the gateway.\n"
                            + "1) `\(commandLine)`\n"
                            + "2) `/pair approve` in your Carina chat\n"
                            + "\(requestLine)\n"
                            + "Carina will also retry automatically when you return to this app.")
                }
            }
...
extension OnboardingWizardView {
    ...
    private func advanceFromIntro() {
        ...
        self.statusLine = "In your Carina chat, run /pair qr, then scan the code here."
        self.step = .welcome
    }
    ...
    private func initializeState() {
        ...
        if !hasSavedGateway, !hasToken, !hasPassword {
            self.statusLine = "No saved pairing found. In your Carina chat, run /pair qr, then scan the code here."
        }
    }
