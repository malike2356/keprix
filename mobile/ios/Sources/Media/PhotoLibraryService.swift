...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: CarinaPhotosLatestParams) async throws -> CarinaPhotosLatestPayload {
        ...
        var results: [CarinaPhotoPayload] = []
        ...
        return CarinaPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> CarinaPhotoPayload
    {
