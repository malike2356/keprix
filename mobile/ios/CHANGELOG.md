# Carina iOS Changelog

## 2026.6.2 - 2026-06-02

Carina is now available on iPhone.

Connect to your Carina Gateway to chat with your assistant, use realtime Talk mode, review approvals, share content from iOS, and bring device capabilities like camera, location, screen, and notifications into your private automation workflows.

## 2026.6.1 - 2026-06-01

Maintenance update for the current Carina release.
...
Maintenance update for the current Carina development release.
...
First App Store release of Carina for iPhone. Pair with your Carina Gateway to use chat, voice, sharing, and device actions from iOS.
