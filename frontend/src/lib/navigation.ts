...
export const primaryNavigation: NavItem[] = [
  ...
  { id: "property", label: "Property", href: "/property", icon: "home", group: "pipeline" },
  { id: "calculators", label: "Property calculators", href: "/calculators", icon: "calculate", group: "pipeline" },
  ...
  { id: "customer-concierge", label: "Customer Concierge", href: "/concierge", icon: "chat", group: "pipeline" },
  ...
  { id: "files", label: "Document Vault", href: "/files", icon: "folder", group: "knowledge" },
  ...
  { id: "agent-os-board", label: "Action board", href: "/agent-os", icon: "dashboard", group: "automations" },
  ...
  { id: "propreneur-sidecar", label: "Property Manager pack", href: "/settings/sidecars/propreneur", icon: "extension", group: "automations" },
...
export const launcherCards: LauncherCard[] = [
  ...
  { id: "documents", title: "Documents", description: "Document Vault explorer and legacy workspace docs.", href: "/documents", icon: "folder" },
  { id: "files", title: "Document Vault", description: "Tenant virtual filesystem; host FS via ?mode=host.", href: "/files", icon: "folder" },
  ...
  { id: "customer-concierge", title: "Customer Concierge", description: "Publish a customer-facing concierge with setup wizard, channels, and webchat.", href: "/concierge", icon: "chat" },
  ...
  { id: "calculators", title: "Property calculators", description: "Run deterministic property investment models with workspace assumptions.", href: "/calculators", icon: "calculate" },
