...
export default function OutreachMergesPage() {
  const { data, error, mutate, isLoading } = useSWR(["crm-merges", WORKSPACE], () =>
    fetchCrmMerges(WORKSPACE),
  );
  ...
  return (
    <Stack spacing={2}>
      ...
      <Typography variant="body2" color="text.secondary">
        Fuzzy identity matches wait here. Never silent merge. Consent/suppression transfer requires an explicit Soft
        Wall step (default deny). Soft merges remain reversible in merge history.
      </Typography>
